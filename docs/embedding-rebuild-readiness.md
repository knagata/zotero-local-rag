...
|---|---|---|
| Rebuild code generation | GO | Extraction/ingestion runtime is pinned at `012ad35a06aadcca28fdc5941ac1cfb446b7a189`. The scoped AI-TOC negative-cache refresh changes only explicit rerun control; extraction heuristics, OCR routes, chunk text/IDs and boundaries remain frozen. |
...
M5 approval to cross the destructive confirmation. With AI TOC enabled, that
approval also permits its paid LLM calls for eligible PDFs during the rebuild.
